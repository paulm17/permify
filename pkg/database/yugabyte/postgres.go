...
// Yugabyte - Structure for Postresql instance
...
// New -
func New(uri string, opts ...Option) (*Yugabyte, error) {
	return newDB(uri, uri, opts...)
}

// NewWithSeparateURIs -
func NewWithSeparateURIs(writerUri, readerUri string, opts ...Option) (*Yugabyte, error) {
	return newDB(writerUri, readerUri, opts...)
}

// new - Creates new postgresql db instance
func newDB(writerUri, readerUri string, opts ...Option) (*Yugabyte, error) {
	pg := &Yugabyte{
...
func (p *Yugabyte) GetMaxDataPerWrite() int {
	return p.maxDataPerWrite
}

func (p *Yugabyte) GetMaxRetries() int {
	return p.maxRetries
}

func (p *Yugabyte) GetWatchBufferSize() int {
	return p.watchBufferSize
}

// GetEngineType - Get the engine type which is postgresql in string
func (p *Yugabyte) GetEngineType() string {
	return "yugabyte"
}

// Close - Close postgresql instance
func (p *Yugabyte) Close() error {
	p.ReadPool.Close()
	p.WritePool.Close()
	return nil
}
...
func (p *Yugabyte) IsReady(ctx context.Context) (bool, error) {
